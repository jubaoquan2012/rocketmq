...
public class NettyServerConfig implements Cloneable {
    ...
    /**
     * Netty pubic 任务线程池个数,Netty 网络设计,根据业务类型会创建不同的线程池:
     * 比如处理消息发送,消息消费,心跳检测等;
    ...
    /**
     * IO线程个数,主要是NameServer、Broker端解析请求
     * 返回相应的的线程个数,这类线程主要是处理网络请求的,解析请求包,然后转发到
    ...
    /** 网络连接最大空闲时间,默认是120s,如果连接空闲时间超过该参数设置的值,连接将被关闭 */
